...
DROP TABLE IF EXISTS `oauth_approvals`;CREATE TABLE `oauth_approvals` (
...
DROP TABLE IF EXISTS `oauth_client_token`;CREATE TABLE `oauth_client_token` (
...
DROP TABLE IF EXISTS `oauth_refresh_token`;CREATE TABLE `oauth_refresh_token` (
...
DROP TABLE IF EXISTS `authority`;CREATE TABLE `authority` (
...
DROP TABLE IF EXISTS `credentials_authorities`;CREATE TABLE `credentials_authorities` (
